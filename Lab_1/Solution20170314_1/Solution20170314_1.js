...
window.onload = function init()
{
	...
	document.getElementById("slidersx").onchange = function(event) {
    sx = parseFloat(event.target.value);
	}
	document.getElementById("slidersy").onchange = function(event) {
    sy = parseFloat(event.target.value);
	}
	document.getElementById("slidersz").onchange = function(event) {
