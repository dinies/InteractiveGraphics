function Scene(){
    ...
    this.create= function(){
        ...
        // build all the trees
    		var tree_list= [];
    		tree_list[0] = new Tree(4.0 , 4.0 , 2, 4);
    		tree_list[0].build();
...
function Tree(x,z, layers, definition){
    this.x= x;
    this.z= z;
    this.layers= layers;
    this.root= new Node();
    ...
    this.build= function(){
        ...
        for (var i = 0; i < this.definition; i++) {
            ...
            this.root.values.set("piece n"+i,  new Parallelepiped( [5.0, 0.5, 0.5], [this.x, 2.0 , this.z ], cubeColors(2),rot_mat));
        };
        //build the other branches
        //TODO
    };
    this.draw= function(gl, view_matrix){
